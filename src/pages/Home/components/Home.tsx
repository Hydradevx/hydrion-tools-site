  ...
  return (
    <div className="flex-col flex items-center mt-6 lg:mt-20">
      ...
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        We are a team of developers and designers dedicated to creating powerful
        and user-friendly tools for automating repetitive tasks in your
        development workflow. Our mission is to simplify, streamline, and
