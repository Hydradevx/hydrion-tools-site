    ...
    <div className="container px-4 mx-auto relative text-sm">
      <div className="flex justify-between items-center">
        ...
        <div className="lg:hidden flex-col md:flex justify-end">
          <button onClick={toggleNavbar} className="flex items-center px-3 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 ease-in-out rounded-full focus:outline-none focus:shadow-outline">
